...
public class RestaurantModel {
    ...
    public void setName(String name) {
        if (name == null) throw new NullException(DomainConstants.NULL_MESSAGE);
        if (name.trim().isEmpty()) throw new EmptyException(DomainConstants.EMPTY_MESSAGE);
    ...
    public void setNit(String nit) {
        if (nit == null) throw new NullException(DomainConstants.NULL_MESSAGE);
        if (nit.trim().isEmpty()) throw new EmptyException(DomainConstants.EMPTY_MESSAGE);
    ...
    public void setAddress(String address) {
        if (address == null) throw new NullException(DomainConstants.NULL_MESSAGE);
        if (address.trim().isEmpty()) throw new EmptyException(DomainConstants.EMPTY_MESSAGE);
        this.address = address;
    }
    ...
    public void setPhoneNumber(String phoneNumber) {
        if (phoneNumber == null) throw new NullException(DomainConstants.NULL_MESSAGE);
        if (phoneNumber.trim().isEmpty()) throw new EmptyException(DomainConstants.EMPTY_MESSAGE);
    ...
    public void setLogoUrl(String logoUrl) {
        if (logoUrl == null) throw new NullException(DomainConstants.NULL_MESSAGE);
        if (logoUrl.trim().isEmpty()) throw new EmptyException(DomainConstants.EMPTY_MESSAGE);
        this.logoUrl = logoUrl;
    }
    ...
    public void setOwnerId(Long ownerId) {
        if (ownerId == null) throw new NullException(DomainConstants.NULL_MESSAGE);
